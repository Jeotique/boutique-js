document.addEventListener('DOMContentLoaded', () => {
    ...
    buyButton.addEventListener('click', () => {
        window.location.href="/page_produit"
    })
    const cars = [
        ...
        carsToDisplay.forEach(car => {
            ...
            carItem.innerHTML = `
                ...
                <div class="car-details">
                    ...
                    <p><strong>Termine dans:</strong> ${car.timeLeft}</p>
                    <div class="buttons">
                        <a href="/panier" class="cta-button acheter">Panier</a>
                        <a href="/payment" class="cta-button acheter">Acheter</a>
                    </div>
                </div>
            `;
